...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_EOF(self):
        h = "Handle End-of-File (EOF) input"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("Prints all string rep. of instances based on class name.\n\n"
             "        Usage:\n"
    ...
    def test_help_count(self):
        h = ("Counts all instances of class class name.\n\n"
             "        Usage:\n"
             "            `<ModelName>all()")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_invalid_syntax(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        correct = "*** Unknown syntax: BaseModel.purge()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("BaseModel.purge()"))
            self.assertEqual(correct, output.getvalue().strip())
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(testID)]
            command = "show Place {}".format(testID) # "Place.show({})"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
    ...
    def test_all_objects_dot_notation(self):
        ...
        for i, model in enumerate(models):
            with patch("sys.stdout", new=StringIO()) as output:
                ...
                models[i] = (model, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("all")
            all_objs = output.getvalue().strip()
        for model in models:
            self.assertIn(model[0], all_objs)
            self.assertIn(model[1], all_objs)
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_attr_value_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update BaseModel {} attr_name".format(testId)
            # "BaseModel.update({}, attr_name)".format(testId)
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update User {} attr_name".format(testId)
            # "User.update({}, attr_name)".format(testId)
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update City {} attr_name".format(testId)
            # "City.update({}, attr_name)".format(testId)
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Place {} attr_name".format(testId)
            # "Place.update({}, attr_name)".format(testId)
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Review {} attr_name".format(testId)
            # "Review.update({}, attr_name)".format(testId)
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_valid_string_attr_dot_notation(self):
        ...
        testCmd = "update BaseModel {} attr_name attr_value".format(tId)
        # "BaseModel.update({}, attr_name, 'attr_value')".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            tId = output.getvalue().strip()
        testCmd = "update State {} attr_name attr_value".format(tId)
        # "State.update({}, attr_name, 'attr_value')".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            tId = output.getvalue().strip()
        testCmd = "update City {} attr_name attr_value".format(tId)
        # "City.update({}, attr_name, 'attr_value')".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
        testCmd = "update Place {} attr_name attr_value".format(tId)
        # "Place.update({}, attr_name, 'attr_value')".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
    ...
    def test_update_valid_dictionary_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = "update BaseModel {} ".format(testId)
        testCmd += "attr_name attr_value" # "{'attr_name': 'attr_value'}"
